...
With a simple set of choices, we can run accessibility tests in our pipelines and generate useful feedback for your development and design teams. Or we can help you implement your own testing setups. This can be part of your test strategy, defining checks that happen every step of the way, in the course of app development.
...
For mobile device tests, we use customised popular frameworks, such as Espresso, XCUITest and Playwright, which enables testing in a more real-life context. 